...
return [
    ...
    'contract' => [
        ...
        'update_status' => 'Update contract status failed.',
    ],
    'password' => [
    ...
    'domain' => [
        ...
        'update' => 'Update domain failed.',
        'delete' => 'Delete domain failed.',
    ],
    'project' => [
    ...
    'income_and_expense_type' => [
        ...
        'update' => 'Update income and expense type failed.',
        'delete' => 'Delete income and expense type failed.',
    ],
    'income_and_expense' => [
        'store' => 'Add new income and expense failed.',
        'update' => 'Update income and expense failed.',
        'delete' => 'Delete income and expense failed.',
    ],
    'employee_type' => [
    ...
    'meeting_type' => [
        ...
        'update' => 'Update meeting type failed.',
        'delete' => 'Delete meeting type failed.',
    ],
    'meeting_schedule' => [
    ...
    'holiday_schedule' => [
        ...
        'update' => 'Update holiday schedule failed.',
        'delete' => 'Delete holiday schedule failed.',
    ],
    'furlough_type' => [
        'store' => 'Add new furlough type failed.',
        'update' => 'Update furlough type failed.',
        'delete' => 'Delete furlough type failed.',
    ],
    'furlough' => [
        'store' => 'Add new furlough failed.',
    ...
    'document_type' => [
        ...
        'delete' => 'Delete document type failed.',
    ],
    'document' => [
        'store' => 'Add new document failed.',

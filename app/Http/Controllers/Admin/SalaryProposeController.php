...
class SalaryProposeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.salary_propose.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.salary_propose.create', compact('users'));
    }
    ...
    {
        return view('admin.salary_propose.show', compact('salaryPropose'));
    }
    ...
    public function edit(SalaryPropose $salaryPropose)
    {
        ...
        return view('admin.salary_propose.edit', compact('salaryPropose', 'users'));
    }

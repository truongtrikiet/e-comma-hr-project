...
class MeetingScheduleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.meeting_schedule.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.meeting_schedule.create', compact(
            'meetingTargetTypes',
            'users',
            'departments'
        ));
    ...
    {
        return view('admin.meeting_schedule.show', compact('meetingSchedule'));
    }
    ...
    public function edit(MeetingSchedule $meetingSchedule)
    {
        ...
        return view('admin.meeting_schedule.edit', compact(
            'meetingSchedule',
            'meetingTargetTypes',
            'users',
            'departments'

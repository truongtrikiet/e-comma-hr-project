...
class CandidateScreeningController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view(
            'admin.candidate_screening.index', compact('positionTypes', 'aiProfiles', 'statuses')
        );
    }
    ...
    public function show(CandidateScreening $candidateScreening)
    {
        ...
        return view('admin.candidate_screening.show', compact('candidateScreening', 'detail'));
    }
    ...
    public function destroy(CandidateScreening $candidateScreening)
    {
        ...
        return to_route('admin.candidate_screening.index');
    }

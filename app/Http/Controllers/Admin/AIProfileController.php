...
class AIProfileController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.ai_profile.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.ai_profile.create', compact(
            'schools',
            'provides',
            'statuses'
        ));
    ...
    public function store(StoreAIProfileRequest $request)
    {
        ...
        return to_route('admin.ai_profile.index');
    }
    ...
    public function edit(AIProfile $ai_profile)
    {
        ...
        return view ('admin.ai_profile.edit', compact(
            'ai_profile',
            'schools', 
            'provides',
            'statuses'

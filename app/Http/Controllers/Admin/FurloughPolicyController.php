...
class FurloughPolicyController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('admin.furlough_policy.index');
    }
    ...
    public function create()
    {
        ...
        return view('admin.furlough_policy.create', compact(
            'isPaid', 
            'statuses',
    ...
    public function store(StoreFurloughPolicy $request)
    {
        ...
        return to_route('admin.furlough-policies.index');
    }
    ...
    {
        return view('admin.furlough_policy.show', compact('furloughPolicy'));
    }
    ...
    public function edit(FurloughPolicy $furloughPolicy)
    {
        ...
        return view('admin.furlough_policy.edit', compact(
            'furloughPolicy',
            'isPaid',
            'statuses',
            'furloughPolicyTemplates',

...
class MeetingScheduleController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('staff.meeting_schedule.index');
    }
    ...
    public function create()
    {
        ...
        return view('staff.meeting_schedule.create', compact(
            'meetingTargetTypes',
            'users',
            'departments'
        ));
    ...
    public function store(StoreMeetingScheduleRequest $request)
    {
        ...
        return to_route('staff.meeting-schedule.index');
    }
    ...
    {
        return view('staff.meeting_schedule.show', compact('meetingSchedule'));
    }
    ...
    public function edit(MeetingSchedule $meetingSchedule)
    {
        ...
        return view('staff.meeting_schedule.edit', compact(
            'meetingSchedule',
            'meetingTargetTypes',
            'users',
            'departments'

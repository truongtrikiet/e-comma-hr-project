...
class AppendixContractController extends Controller
{
    ...
    {
        return view('hr.appendix_contract.create', compact('contract'));
    }
    ...
    public function store(StoreAppendixContractRequest $request, Contract $contract)
    {
        ...
        return to_route('hr.contract.show', $contract);
    }
    ...
    {
        return view('hr.appendix_contract.edit', compact('contract', 'appendixContract'));
    }

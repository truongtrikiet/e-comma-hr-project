...
class ContractAttributeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('hr.contract_attribute.index');
    }
    ...
    {
        return view('hr.contract_attribute.create');
    }
    ...
    public function store(StoreContractAttributeRequest $request)
    {
        ...
        return to_route('hr.contract_attribute.index');
    }
    ...
    {
        return view('hr.contract_attribute.edit', compact('contractAttribute'));
    }

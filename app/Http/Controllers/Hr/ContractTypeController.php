...
class ContractTypeController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('hr.contract_type.index');
    }
    ...
    public function create()
    {
        ...
        return view('hr.contract_type.create', compact('contractAttributes', 'schools'));
    }
    ...
    public function edit(ContractType $contractType)
    {
        ...
        return view('hr.contract_type.edit', compact('contractType', 'contractAttributes', 'schools'));
    }

...
class FurloughPolicyTemplateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('hr.furlough_policy_template.index');
    }
    ...
    public function create()
    {
        ...
        return view('hr.furlough_policy_template.create', compact('isPaid', 'statuses'));
    }
    ...
    public function store(StoreFurloughPolicyTemplate $request)
    {
        ...
        return to_route('hr.furlough-policy-template.index');
    }
    ...
    public function edit(FurloughPolicyTemplate $furloughPolicyTemplate)
    {
        ...
        return view('hr.furlough_policy_template.edit', compact(

...
class ContractController extends Controller
{
    ...
    public function create()
    {
        ...
        return view('hr.contract.create', compact('contractTypes', 'users'));
    }
    ...
    public function store(StoreContractRequest $request)
    {
        ...
        return to_route('hr.contract.index');
    }
    ...
    {
        return view('hr.contract.show', compact('contract'));
    }
    ...
    public function edit(Contract $contract)
    {
        ...
        return view('hr.contract.edit', compact(
            'contract',
            'contractTypes',
            'users',
            'contractTypeAttributesMap',

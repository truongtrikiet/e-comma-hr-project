<x-hr.base-layout :scrollspy="false">
    ...
    <x-custom.stat-box :id="'salary-management-filter'" :custom-col="'col-lg-12'">
        ...
        @include('hr.salary.filters.index')
    </x-custom.stat-box>
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "render": function (data, type, full) {
                            ...
                            let urlDestroy = `{{ route('hr.salary.destroy', ':id') }}`.replace(':id', data);
                            ...
                            return `
                                <ul class="table-controls d-flex justify-content-center">
                                    ...
                                    <x-table.actions.delete-action
                                        :permission="Acl::PERMISSION_SALARY_DELETE"
                                        :url="'${urlDestroy}'"
                                        :datatableId="'sSalaryTable'"
                                    />
                                </ul>`;
                            }
                        }

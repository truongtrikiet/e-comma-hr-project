<x-hr.base-layout :scrollspy="false">
    ...
    <x-custom.breadcrumb
        :breadcrumb-items="[
            __('general.menu.furlough_policy_management.manage_furlough_policy') => route('hr.furlough-policies.index'),
    ...
    <x-form.form-layout
        ...
        :form-url="route('hr.furlough-policies.update', $furloughPolicy->id)"
        :form-method="'PUT'"

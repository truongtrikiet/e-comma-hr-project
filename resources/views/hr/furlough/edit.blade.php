<x-hr.base-layout :scrollspy="false">
    ...
    <x-custom.breadcrumb
        :breadcrumb-items="[
            __('general.menu.furlough_management.manage_furlough') => route('hr.furlough.index'),
            __('general.menu.furlough_management.edit_furlough') => '',
        ]"
    />
    ...
    <x-form.form-layout
        ...
        :form-url="route('hr.furlough.update', $furlough->id)"
        :formMethod="'PUT'"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <x-form.form-select
                                ...
                                :isRequired="true"
                                :selected="$furlough->use_balance->value"
                            />
                        </div>
                    </div>
                </div>

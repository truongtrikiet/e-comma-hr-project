            ...
            <div class="card">
                ...
                <div class="card-footer">
                    @can(\App\Acl\Acl::PERMISSION_MEETING_SCHEDULE_EDIT)
                        <x-buttons.button-link :label="__('general.common.edit')" :url="route('hr.meeting-schedule.edit', $meetingSchedule->id)" />
                    @endcan
                    <x-buttons.button-link :label="__('general.common.back')" :url="route('hr.meeting-schedule.index')" />
                </div>
            </div>
        </div>
    </div>

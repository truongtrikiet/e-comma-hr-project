<x-hr.base-layout :scrollspy="false">
    ...
    <x-custom.breadcrumb
        :breadcrumb-items="[
            __('general.menu.contract_management.contract') => route('hr.contract.index'),
    ...
    <x-form.form-layout
        ...
        :form-url="route('hr.contract.update', $contract->code)"
        :form-method="'PUT'"
    ...
    <x-slot:footerFiles>
        ...
        <script>
            ...
            if (!EditorClass) {
                ...
                ckfinder: {
                    uploadUrl: '{{ route('hr.editor_upload', ['_token' => csrf_token()]) }}',

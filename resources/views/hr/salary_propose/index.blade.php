        ...
        <div>
            @can(Acl::PERMISSION_SALARY_PROPOSE_ADD)
                <x-buttons.button-link
                    ...
                    :url="route('hr.salary-propose.create')"
                />
            @endcan
        </div>
    </div>
            ...
            <x-slot:customScript>
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function (data, type, full) {
                            let urlEdit = `{{ route('hr.salary-propose.edit', ':id') }}`.replace(':id', data);
                            let urlShow = `{{ route('hr.salary-propose.show', ':id') }}`.replace(':id', data);
                            let urlDestroy = `{{ route('hr.salary-propose.destroy', ':id') }}`.replace(':id', data);

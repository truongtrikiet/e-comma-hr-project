<x-hr.base-layout :scrollspy="false">
    ...
    <x-custom.breadcrumb
        :breadcrumb-items="[
            __('general.menu.salary_propose_management.title') => route('hr.salary-propose.index'),
            __('general.menu.salary_propose_management.create_salary_propose') => '',
        ]"
    />
    ...
    <x-form.form-layout
        ...
        :form-url="route('hr.salary-propose.approved', $salaryPropose->id)"
        :form-method="'POST'"
        :card-title="__('general.menu.salary_propose_management.create_salary_propose')"
    ...
    >
        <div class="row">
            <div class="col-lg-8">
                <div class="mb-3">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <x-form.form-select
                                :id="'sSalaryProposeStatus'"
                                :label="__('general.common.status')"
                                :data-values="App\Enum\SalaryStatus::options()"
                                :select-value-attribute="'value'"
                                :select-value-label="'label'"
                                :name="'status'"
                                :multiple="false"
                                :placeholder="__('general.common.status')"
                                :selected="$salaryPropose->status->value"
                            />
                        </div>
                    </div>
                </div>
            ...
            <div class="col-lg-8">
                <div class="mb-3">
                    @can(Acl::PERMISSION_SALARY_PROPOSE_EDIT)

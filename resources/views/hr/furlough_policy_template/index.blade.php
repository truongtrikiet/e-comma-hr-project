        ...
        <div>
            @can(Acl::PERMISSION_FURLOUGH_POLICY_TEMPLATE_ADD)
                <x-buttons.button-link
                    ...
                    :url="route('hr.furlough-policy-template.create')"
                />
            @endcan
        </div>
    </div>
            ...
            <x-slot:customScript>
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function (data, type, full) {
                            let urlEdit = `{{ route('hr.furlough-policy-template.edit', ':id') }}`.replace(':id', data);
                            let urlDestroy = `{{ route('hr.furlough-policy-template.destroy', ':id') }}`.replace(':id', data);

        ...
        <div>
            @can(Acl::PERMISSION_FURLOUGH_ADD)
                <x-buttons.button-link
                    ...
                    :url="route('staff.furlough.create')"
                />
            @endcan
        </div>
    </div>
            ...
            <x-slot:customScript>
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function (data, type, full) {
                            let urlShow = `{{ route('staff.furlough.show', ':id') }}`.replace(':id', data);
                            let urlEdit = `{{ route('staff.furlough.edit', ':id') }}`.replace(':id', data);
                            let urlDestroy = `{{ route('staff.furlough.destroy', ':id') }}`.replace(':id', data);

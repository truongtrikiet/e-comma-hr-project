<x-staff.base-layout :scrollspy="false">
    <x-slot:pageTitle>
        {{ __('general.menu.salary_management.create_salary') }}
    </x-slot:pageTitle>
    <x-slot:headerFiles>
    ...
    <x-form.form-layout
        ...
        :form-url="route('staff.salary.store')"
        :card-title="__('general.menu.salary_management.create_salary')"
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <x-form.form-input
                    ...
                    :type="'text'"
                />
                <input type="hidden" name="gross_amount" id="gross_amount" value="{{ old('gross_amount') }}">
                ...
                <x-form.form-input
                    ...
                    :type="'text'"
                />
                <input type="hidden" name="tax_percent" id="tax_percent" value="{{ old('tax_percent') }}">
                ...
                <x-form.form-input
                    ...
                    :type="'text'"
                />
                <input type="hidden" name="tax_amount" id="tax_amount" value="{{ old('tax_amount') }}">
                ...
                <x-form.form-input
                    ...
                    :type="'text'"
                />
                <input type="hidden" name="net_amount" id="net_amount" value="{{ old('net_amount') }}">

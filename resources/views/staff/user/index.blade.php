            ...
            <x-slot:customScript>
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function (data, type, full) {
                            let urlShow = `{{ route('staff.user.show', ':id') }}`.replace(':id', data);
                            let urlEdit = `{{ route('staff.user.edit', ':id') }}`.replace(':id', data);
                            let urlDestroy = `{{ route('staff.user.destroy', ':id') }}`.replace(':id', data);

        ...
        <div>
            @can(Acl::PERMISSION_MEETING_SCHEDULE_ADD)
                <x-buttons.button-link
                    ...
                    :url="route('staff.meeting-schedule.create')"
                />
            @endcan
        </div>
    </div>
            ...
            <x-slot:customScript>
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function (data, type, full) {
                            let urlShow = `{{ route('staff.meeting-schedule.show', ':id') }}`.replace(':id', data);
                            let urlEdit = `{{ route('staff.meeting-schedule.edit', ':id') }}`.replace(':id', data);
                            let urlDestroy = `{{ route('staff.meeting-schedule.destroy', ':id') }}`.replace(':id', data);

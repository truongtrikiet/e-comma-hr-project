<x-base-layout :scrollspy="false">
    ...
    <x-custom.breadcrumb
        :breadcrumb-items="[
            __('general.menu.employee_type_management.employee_type') => route('admin.employee-type.index'),
            __('general.menu.employee_type_management.edit_employee_type') => '',
        ]"
    />

    <x-form.form-layout
        :form-id="'general-settings'"
        :form-url="route('admin.employee-type.update', $employeeType->id)"
        :form-method="'PUT'"
        :card-title="__('general.menu.employee_type_management.edit_employee_type')"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <x-custom.locale-tab
                                ...
                                :fields="[
                                    [
                                        ...
                                        'value' => $employeeType->getTranslations('name'),
                                        'isRequired' => true,
                                    ],
                                ]"
                            />
                            ...
                            <x-form.form-select
                                ...
                                :isRequired="true"
                                :selected="old('status', $employeeType->status->value)"
                            />
                        </div>
                    </div>
                </div>

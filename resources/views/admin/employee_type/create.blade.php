<x-base-layout :scrollspy="false">
    ...
    <x-custom.breadcrumb
        :breadcrumb-items="[
            ...
            __('general.menu.employee_type_management.create_employee_type') => '',
        ]"
    />

    <x-form.form-layout
        :form-id="'general-settings'"
        :form-url="route('admin.employee-type.store')"
        :card-title="__('general.menu.employee_type_management.create_employee_type')"

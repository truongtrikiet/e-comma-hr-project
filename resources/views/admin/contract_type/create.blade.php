<x-base-layout :scrollspy="false">
    ...
    <x-custom.breadcrumb
        :breadcrumb-items="[
            __('general.menu.contract_type_management.contract_type') => route('admin.contract_type.index'),
            __('general.menu.contract_type_management.create_contract_type') => '',
        ]"
    />

    <x-form.form-layout
        :form-id="'general-settings'"
        :form-url="route('admin.contract_type.store')"
        :card-title="__('general.menu.contract_type_management.create_contract_type')"

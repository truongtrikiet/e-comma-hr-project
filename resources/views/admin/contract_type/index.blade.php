        ...
        <div>
            @can(Acl::PERMISSION_CONTRACT_TYPE_ADD)
                <x-buttons.button-link
                    ...
                    :url="route('admin.contract_type.create')"
                />
            @endcan
        </div>
    </div>
            ...
            <x-slot:customScript>
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function (data, type, full) {
                            let urlEdit = `{{ route('admin.contract_type.edit', ':id') }}`.replace(':id', data);
                            let urlDestroy = `{{ route('admin.contract_type.destroy', ':id') }}`.replace(':id', data);

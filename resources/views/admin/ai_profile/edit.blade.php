<x-base-layout :scrollspy="false">
    <x-slot:pageTitle>
        {{ __('general.menu.ai_profile_management.edit_ai_profile') }}
    </x-slot:pageTitle>
    <x-slot:headerFiles>
    ...
    <x-custom.breadcrumb
        :breadcrumb-items="[
            __('general.menu.ai_profile_management.manage_ai_profile') => route('admin.ai_profile.index'),
            __('general.menu.ai_profile_management.edit_ai_profile') => '',
        ]"
    />
    ...
    <x-form.form-layout
        ...
        :form-url="route('admin.ai_profile.update', $ai_profile->id)"
        :form-method="'PUT'"
        :card-title="__('general.menu.ai_profile_management.edit_ai_profile')"
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <x-form.form-select
                                ...
                                :isRequired="true"
                                :selected="$ai_profile->provider->value"
                            />
                            ...
                            <x-form.form-textarea
                                ...
                                :rows="4"
                                :isRequired="true"
                                :value="$ai_profile->api_key_encrypted"
                            />
                            ...
                            <x-form.form-select
                                ...
                                :isRequired="true"
                                :selected="$ai_profile->status->value"
                            />
                        </div>
                    </div>
                </div>

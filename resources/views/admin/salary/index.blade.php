<x-base-layout :scrollspy="false">
    ...
    <x-custom.stat-box :id="'salary-management-filter'" :custom-col="'col-lg-12'">
        ...
        @include('admin.salary.filters.index')
    </x-custom.stat-box>
            ...
            <x-slot:customScript>
                ...
                "url": "{{ route('admin.salary.index') }}",
                    "data": function(d) {
                        ...
                        d.status = $('#sSalaryStatus').val() || searchParams.get('status');
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function (data, type, full) {
                            let urlEdit = `{{ route('admin.salary.edit', ':id') }}`.replace(':id', data);
                            let urlShow = `{{ route('admin.salary.show', ':id') }}`.replace(':id', data);

<x-base-layout :scrollspy="false">
    ...
    <x-custom.breadcrumb
        :breadcrumb-items="[
            ...
            __('general.menu.school_working_calendar_management.edit_school_working_calendar') => '',
        ]"
    />

    <x-form.form-layout
        :form-id="'general-settings'"
        :form-url="route('admin.school-working-calendar.update', $schoolWorkingCalendar->id)"
        :form-method="'PUT'"
        :card-title="__('general.menu.school_working_calendar_management.edit_school_working_calendar')"
                        ...
                        <div class="col-md-12">
                            @if (session('school_name') === config('subdomain.system_main'))
                                <x-form.form-select
                                    ...
                                    :isRequired="false"
                                    :selected="$schoolWorkingCalendar->school_id"
                                />
                            @else
                            ...
                            <x-form.form-select-multiple
                                ...
                                :isRequired="true"
                                :selected="$schoolWorkingCalendar->working_days"
                            />
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <x-form.form-input
                                        ...
                                        :isRequired="true"
                                        :value="$schoolWorkingCalendar->working_hours_start"
                                    />
                                </div>
                                <div class="col-md-6">
                                    <x-form.form-input
                                        ...
                                        :isRequired="true"
                                        :value="$schoolWorkingCalendar->working_hours_end"
                                    />
                                </div>
                            </div>
                            ...
                            <x-form.form-select
                                ...
                                :isRequired="true"
                                :selected="$schoolWorkingCalendar->is_active->value"
                            />
                        </div>
                    </div>
                </div>

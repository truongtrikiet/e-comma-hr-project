<x-base-layout :scrollspy="false">
    ...
    <x-custom.breadcrumb
        :breadcrumb-items="[
            __('general.menu.furlough_policy_template_management.manage_furlough_policy_template') => route('admin.furlough-policy-template.index'),
    ...
    <x-form.form-layout
        ...
        :form-url="route('admin.furlough-policy-template.update', $furloughPolicyTemplate->id)"
        :form-method="'PUT'"

<x-base-layout :scrollspy="false">
    ...
    <x-custom.breadcrumb
        :breadcrumb-items="[
            ...
            __('general.menu.furlough_type_management.create_furlough_type') => '',
        ]"
    />

    <x-form.form-layout
        :form-id="'general-settings'"
        :form-url="route('admin.furlough-type.store')"
        :card-title="__('general.menu.furlough_type_management.create_furlough_type')"

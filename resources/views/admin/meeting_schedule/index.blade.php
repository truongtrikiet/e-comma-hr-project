        ...
        <div>
            @can(Acl::PERMISSION_MEETING_SCHEDULE_ADD)
                <x-buttons.button-link
                    ...
                    :url="route('admin.meeting-schedule.create')"
                />
            @endcan
        </div>
    </div>
            ...
            <x-slot:customScript>
                ...
                "columns": [
                    ...
                    },
                    {
                        ...
                        "orderable": false,
                        "render": function (data, type, full) {
                            let urlShow = `{{ route('admin.meeting-schedule.show', ':id') }}`.replace(':id', data);
                            let urlEdit = `{{ route('admin.meeting-schedule.edit', ':id') }}`.replace(':id', data);
                            let urlDestroy = `{{ route('admin.meeting-schedule.destroy', ':id') }}`.replace(':id', data);

                            ...
                            <div class="col-xl-12">
                                <div class="auth-form">
                                    ...
                                    <div class="d-flex justify-content-end mb-2">
                                        <div>
                                            <a href="{{ route('locale.switch', ['locale' => 'en', 'redirect_to' => route('auth.login.show-form')]) }}" class="mr-2">EN</a>
                                            <a href="{{ route('locale.switch', ['locale' => 'vi', 'redirect_to' => route('auth.login.show-form')]) }}">VI</a>
                                        </div>
                                    </div>
                                    @if ($errors->any())
